...
class HE_DataModule(pl.LightningDataModule):
    ...
    def add_dataset_specific_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        parser.add_argument(
            "--root",
            type = str,
            default = '/home/data/nolan_lab/Tonsil_HandE/bestFocus',
    ...
    def prepare_data(self):
        ...
        if self.prepare:
           ...
           train_dataset = HEdataset (prepare=self.prepare, dataset_type="train",transformations=None, **self.dataset_kwargs)
    ...
    def setup(self, stage=None):
        ...
        # Determining transformations to apply.
              ...
              if self.normalize_transform:
                  ...
                  std = np.loadtxt(path.join("/home/axh5735/projects/compressed_images_HandE/code/with_umap/H&E_Codex/H&E/logs/HandE_gray_Tonsil_128_256/stat", "std.gz"))
                  mean = np.loadtxt(path.join("/home/axh5735/projects/compressed_images_HandE/code/with_umap/H&E_Codex/H&E/logs/HandE_gray_Tonsil_128_256/stat", "mean.gz"))
        ...
        if stage in (None, "fit"):
            self.train_dataset = HEdataset(dataset_type="train", transformations=transformations
                                           ,prepare=False, **self.dataset_kwargs)
          
            self.val_dataset = HEdataset(dataset_type="val", transformations=transformations,
                                          prepare=False, **self.dataset_kwargs)
            ...
            self.test_dataset = HEdataset(dataset_type="test", transformations=transformations
                                          ,prepare=False, **self.dataset_kwargs)
